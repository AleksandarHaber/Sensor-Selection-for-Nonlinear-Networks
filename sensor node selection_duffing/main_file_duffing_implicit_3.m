...
figure(8)
%hist(error_random)
histogram(error_random, 15, 'Normalization','probability','FaceColor','k','FaceAlpha',0.3 )
ytix = get(gca, 'YTick')
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100)
hold on 
line([solution_optimal_error_4 solution_optimal_error_4], [0 0.25],'color','r','linewidth',2);
